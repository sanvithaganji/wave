...
async function GET(req, { params }) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).lean();
        if (!project) {
        ...
        const approvedProfiles = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            uid: {
                $in: projectObj.approvedUsers || []
            }
        }, {
            password: 0,
            email: 0
        ...
        const pendingUids = (projectObj.interestedUsers || []).filter((uid)=>!(projectObj.approvedUsers || []).includes(uid));
        const interestedProfiles = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            uid: {
                $in: pendingUids
            }
        }, {
...
async function PUT(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!project) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Project not found'
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77eade6c._.js.map