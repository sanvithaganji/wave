...
function AuthPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // If the user visits /auth while already logged in,
        // sign them out so they can switch or create a new account.
        if (!authLoading && user) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signOut"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"]);
        }
    }, [
        user,
        authLoading
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            if (mode === 'signup') {
                ...
                // Brand new account — go straight to the AI interview
                ...
                // Returning user — authLoading effect will redirect correctly
                // but also push now so we don't wait on Firestore
                router.push('/swipe');
            }
        } catch (err) {
            const code = err?.code || '';
    ...
    // Always show the form — never block on authLoading
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60e28773._.js.map