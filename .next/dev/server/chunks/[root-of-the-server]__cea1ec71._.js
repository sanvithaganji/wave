...
async function GET(req) {
    try {
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            uid: {
                $ne: tokenUser.uid
            },
            isActive: true,
            profileCompleted: true
        }).select('-password -email -phone -realName').lean();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            users
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cea1ec71._.js.map