...
function ProjectsPage() {
    ...
    const [interested, setInterested] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
            ...
            const loadProjects = {
                "ProjectsPage.useEffect.loadProjects": async ()=>{
                    try {
                        ...
                        const live = raw.map({
                            "ProjectsPage.useEffect.loadProjects.live": (p)=>({
                                    id: p._id || p.id,
                                    name: p.name,
                                    type: p.category,
                                    domain: p.domain,
                        ...
                        }["ProjectsPage.useEffect.loadProjects.live"]).filter({
                            "ProjectsPage.useEffect.loadProjects.live": (p)=>p.members < p.maxMembers
                        }["ProjectsPage.useEffect.loadProjects.live"]);
                        if (live.length > 0) {
                            setProjects(live);
                            if (user) {
                                const init = {};
...
_s(ProjectsPage, "L9Qby5KuGRIdkj2gjezxagRm378=", false, function() {
    return [
